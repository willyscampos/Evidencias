...
app.config(function ($routeProvider, $locationProvider) {
    ...
    $routeProvider.when('/cadastro', { templateUrl: "cadastro.html" });
    $routeProvider.when('/registro', { templateUrl: "registro.html" });
    $routeProvider.when('/logon', { templateUrl: "logon.html" });
